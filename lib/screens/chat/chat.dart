...
class _ChatPageState extends State<ChatPage> {
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            var isLastSenderMessage = messages[index].id == lastSenderMessage?.id;
            var isLastReceiverMessage = messages[index].id == lastReceiverMessage?.id;
            return _buildMessageItem(messages[index], isLastSenderMessage, isLastReceiverMessage);
          },
        );
      },
    );
  ...
  // build message item
  Widget _buildMessageItem(QueryDocumentSnapshot doc, bool isLastSenderMessage, bool isLastReceiverMessage) {
